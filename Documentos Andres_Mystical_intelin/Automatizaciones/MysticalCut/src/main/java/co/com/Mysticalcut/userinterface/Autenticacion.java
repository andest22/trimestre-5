...
public class Autenticacion extends PageObject {
    ...
    public static Target MENSAJE_LOGIN = Target.the("mensaje de login").located(By.xpath("/html/body/div/div/div/header/div/div/button"));

    public static Target MENSAJE_MODULS_SERVICES = Target.the("mensaje de login").located(By.xpath("/html/body/div/div/div/div[1]/header/ul/li[3]/a"));

    public static Target MENSAJE_MODULS_PRODUCTS= Target.the("mensaje de login").located(By.xpath("/html/body/div/div/div/div[1]/header/ul/li[4]/a"));

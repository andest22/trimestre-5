...
public class Quotes extends PageObject {
    ...
    public static Target MENSAJE_QUOTES_SERVICES = Target.the("Correo Cliente").located(By.xpath("/html/body/div/div/div/div/div/div/div[1]/span[2]"));

    public static Target MENSAJE_QUOTES_BARBER = Target.the("Correo Cliente").located(By.xpath("/html/body/div/div/div/div/div/div/div[2]/span[2]"));
